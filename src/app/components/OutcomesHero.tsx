    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-600 via-orange-700 to-red-800 text-white px-6">
      <div className="max-w-6xl">
        <div className="mb-8">
          ...
          <h1 className="text-7xl font-bold mb-4">StoryPath</h1>
        ...
        <div className="bg-white bg-opacity-15 backdrop-blur rounded-2xl p-6 mb-8 border border-white border-opacity-30">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-bold text-xl">
              Community Impact & Accessibility First
            </h3>
          </div>
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-sm opacity-75">
                github.com/joseph-c-mcguire/story-path
              </div>
            </div>
          </a>
          <a
        ...
        <div className="mt-12 flex items-center gap-4 text-sm opacity-75">
          ...
          <span>
            Qvest US • Presented by Joseph McGuire • February
            2026
          </span>
        </div>
      </div>
