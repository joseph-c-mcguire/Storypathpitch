      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-6 mb-12">
          ...
          <p className="text-2xl text-gray-600">
            Leading indicators that support Providence's goal:
            24% → 50% of 3rd graders reading on grade level by
            2030
          </p>
        </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-sm opacity-90">
                Target: 2.5 → 3.25 books/month per patron
              </div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-sm opacity-90">
                Target: 60% → 81% return within 1 month
              </div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-lg font-semibold mb-2">
                Access Availability (Goal)
              </div>
              <div className="text-sm opacity-90">
                Target: Extend beyond librarian hours
              </div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-sm opacity-90">
                Target: Positive feedback on recommendations
              </div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-sm opacity-90">
                Target: Query to recommendation display
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl p-8 shadow-lg">
            <h3 className="text-2xl font-bold mb-4">
              Aligned with District & State Goals
            </h3>
            <ul className="space-y-3 text-lg">
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-yellow-300 flex-shrink-0 mt-1" />
                <div>
                  <strong>Providence Goal: 24% → 50%</strong> of
                  3rd graders reading on grade level by 2030
                  <div className="text-sm opacity-90 mt-1">
                    Our metrics (volume, engagement, access) are
                    leading indicators for this lagging
                    indicator
                  </div>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong>
                    RI Personal Literacy Plans (PLPs):
                  </strong>{" "}
                  Support intervention planning
                  <div className="text-sm opacity-90 mt-1">
                    Librarian dashboard identifies struggling
                    readers for PLP referral
                  </div>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  100% increase in low-income children reading
                  proficiently
                  <div className="text-sm opacity-90 mt-1">
                    24/7 access + anonymous mode removes
                    economic barriers
                  </div>
                </div>
              </li>
            ...
            <div className="mt-4 pt-4 border-t border-white border-opacity-30 text-xs opacity-80">
              ...
              <a
                href="https://www.providenceschools.org/about-us/school-board/community-listening-sessions"
              ...
              •
              <a
                href="https://ride.ri.gov/instruction-assessment/literacy/personal-literacy-plans"
                className="underline ml-1 hover:text-yellow-300"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              •
              <a
                href="https://www.imls.gov/our-work/partnerships/campaign-grade-level-reading"
                className="underline ml-1 hover:text-yellow-300"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <div className="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl p-8 shadow-lg">
            ...
            <ul className="space-y-3 text-lg">
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-yellow-300 flex-shrink-0 mt-1" />
                <span>
                  <strong>Hybrid AI:</strong> LLM + Vector +
                  Collaborative filtering for superior
                  recommendations
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-yellow-300 flex-shrink-0 mt-1" />
                <span>
                  <strong>Privacy-first:</strong> FERPA + COPPA
                  compliant with anonymous browsing mode
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-yellow-300 flex-shrink-0 mt-1" />
                <span>
                  <strong>Librarian-centered:</strong> Dashboard
                  empowers staff, doesn't replace their
                  expertise
                </span>
              </li>
            </ul>
        ...
        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-8 shadow-lg mb-8">
          ...
          <div className="grid grid-cols-4 gap-4 relative">
            {/* Connecting line */}
            <div
              className="absolute top-10 left-0 right-0 h-0.5 bg-white bg-opacity-30"
              style={{
                marginLeft: "12.5%",
                marginRight: "12.5%",
              }}
            ...
            <div className="text-center relative z-10">
              ...
              <div className="text-base opacity-90 leading-relaxed">
                Pilot deployment (1 library branch)
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white rounded-2xl p-12 text-center shadow-2xl">
          <h3 className="text-4xl font-bold mb-4">
            Ready to Transform Student Reading
          </h3>
          <p className="text-xl mb-6">
            Let's partner with Providence Public Schools to
            deliver this system
          </p>
