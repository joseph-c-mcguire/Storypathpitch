    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur rounded-2xl p-8 border-2 border-white border-opacity-20 mb-8">
          <h3 className="text-3xl font-bold mb-8">Key Performance Indicators (6 Months Post-Launch)</h3>
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-lg font-semibold mb-2">Checkout Rate from Recommendations</div>
              <div className="text-sm opacity-90">Baseline: 2.5 books/month → Target: 3.25 books/month</div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-lg font-semibold mb-2">Repeat Patrons</div>
              <div className="text-sm opacity-90">60% → 81% of patrons return for another book within 1 month</div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-lg font-semibold mb-2">Weekly Active Readers</div>
              <div className="text-sm opacity-90">Extend access beyond librarian hours</div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-sm opacity-90">Positive feedback (thumbs up) on recommendations</div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-sm opacity-90">Average time from query to recommendation display</div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur rounded-xl p-6">
              ...
              <div className="text-sm opacity-90">Availability target for patron-facing kiosk</div>
            </div>
          </div>
        </div>
